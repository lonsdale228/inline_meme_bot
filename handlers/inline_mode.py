    ...
    match query:
        case "s":
            ...
            for meme in meme_list:
                results.append(
                    InlineQueryResultCachedSticker(
                        sticker_file_id=meme.file_id, title=meme.name, id=str(meme.id)
                    )
                )
        case "v":
            ...
            for meme in meme_list:
                results.append(
                    InlineQueryResultCachedVideo(
                        title=meme.name, video_file_id=meme.file_id, id=str(meme.id)
                    )
                )
        case "a":
        ...
        case "p":
            ...
            for meme in meme_list:
                results.append(
                    InlineQueryResultCachedPhoto(
                        title=meme.name, photo_file_id=meme.file_id, id=str(meme.id)
                    )
                )
        case "g":
            ...
            for meme in meme_list:
                results.append(
                    InlineQueryResultCachedGif(
                        title=meme.name, gif_file_id=meme.file_id, id=str(meme.id)
                    )
                )
    ...
    for meme in meme_list:
        match meme.mime_type:
            ...
            case "audio":
                results.append(
                    InlineQueryResultCachedDocument(
                        title=meme.name, document_file_id=meme.file_id, id=str(meme.id)
                    )
                )
            case "sticker":
                results.append(
            ...
            case "gif":
                results.append(
                    InlineQueryResultCachedGif(
                        gif_file_id=meme.file_id, title=meme.name, id=str(meme.id)
                    )
                )
            case "photo":
                results.append(
                    InlineQueryResultCachedPhoto(
                        photo_file_id=meme.file_id, title=meme.name, id=str(meme.id)
                    )
                )
